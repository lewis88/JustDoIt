...
public class NoteDisplay {
    ...
    protected AbsActivity mContext;

    public NoteDisplay(AbsActivity context, String headingText, String contentText, int taskComplete, String id) {
        mContext = context;
    ...
    public ViewGroup createVerticalLinearLayout() {
        ...
        vLayout.setBackgroundResource(R.drawable.note_shape);
